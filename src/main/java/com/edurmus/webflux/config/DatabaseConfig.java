package com.edurmus.webflux.config;

import com.edurmus.webflux.config.converter.CourseMetaDataJsonConverter;
import com.edurmus.webflux.config.converter.JsonToCourseMetaDataConverter;
...
public class DatabaseConfig extends AbstractR2dbcConfiguration {
    ...
    @Value("${spring-webflux.database.user}")
    private String user;
    ...
    public R2dbcCustomConversions r2dbcCustomConversions() {
        ...
        converters.add(new CourseMetaDataJsonConverter(objectMapper()));
